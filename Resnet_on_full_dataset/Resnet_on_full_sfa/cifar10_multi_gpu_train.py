...
tf.app.flags.DEFINE_string('input_filename', 'SFA_pixel_regions_training_random_pixels_set.tfrecords',
                           """TFRecords training set filename""")

tf.app.flags.DEFINE_string('eval_filename', 'SFA_pixel_regions_validation_random_pixels_set.tfrecords',
