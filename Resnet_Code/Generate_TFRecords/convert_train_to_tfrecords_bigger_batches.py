...
n_skin_examples_per_image = 40000
n_background_examples_per_image = int(40000*1.5)
skin_per_image = []
...
for fidx, filename in enumerate(full_ori_train_filenames):
    ...
    for sk_idx in range(n_skin_examples_per_image):
        os.system('clear')
        print "%f%%" % ((float(sk_idx + 1 + fidx*(n_skin_examples_per_image+n_background_examples_per_image) )/ total_examples) * 100)
    ...
    for b_idx in range(n_background_examples_per_image):
        os.system('clear')
        print "%f%%" % ((float(b_idx + 1 + fidx*(n_skin_examples_per_image + n_background_examples_per_image) + n_skin_examples_per_image )/ total_examples) * 100)
